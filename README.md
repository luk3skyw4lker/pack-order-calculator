...
Pack sizes can be dynamically created and stored in a PostgreSQL database. The application is built using Go and the Fiber web framework, and it is containerized using Docker for easy deployment.

## Features

- Input the available pack sizes.
...
- Only whole packs can be sent, no packs can be broken open
